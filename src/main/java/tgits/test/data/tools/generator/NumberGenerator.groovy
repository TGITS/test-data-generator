...
class NumberGenerator {
    ...
    String getIntegerAsString(int numberOfDigits) {
        ...
        if (numberOfDigits < 1) {
            throw new IllegalArgumentException("The given parameter for the number of digits must be greater or equal to 1");
        }
    ...
    List<String> getListOfIntegerAsString(int numberOfDigits, int maxSize) {
    ...
    List<String> getFixedSizeListOfIntegerAsString(int numberOfDigits, int size) {
