...
class LuhnNumberGeneratorTest extends Specification {
    ...
    def "create a list of 20 Luhn numbers"() {
        when:
        listOfLuhnNumbers = generator.getList(15,20)
        then:
    ...
    def "create an array of 20 Luhn numbers"() {
        when:
        arrayOfLuhnNumbers = generator.getArray(15,20)
        then:
    ...
    def "create a list of 1 Luhn number"() {
        when:
        listOfLuhnNumbers = generator.getList(15,1)
        then:
    ...
    def "create an array of 1 Luhn number"() {
        when:
        arrayOfLuhnNumbers = generator.getArray(15,1)
        then:
