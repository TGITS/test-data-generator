...
class IntegerGeneratorTest extends Specification {
    ...
    def "create a random positive integer of 1 digit"() {
        ...
        then:
        validator.isAnInteger(number) && validator.isAPositiveInteger(number) && number.size() == 1
    }
    ...
    def "create a random positive integer of 1 digit with a sign +"() {
        ...
        then:
        validator.isAnInteger(number) && validator.isAPositiveInteger(number) && number.size() == 2
    }
    ...
    def "create a random negative integer of 1 digit with a sign -"() {
        ...
        then:
        validator.isAnInteger(number) && validator.isANegativeInteger(number) && number.size() == 2
    }
    ...
    def "create a random integer of 12 digits"() {
        ...
        then:
        validator.isAnInteger(number) && validator.isAPositiveInteger(number) && number.size() == 12
    }
    ...
    def "create a random positive integer of 12 digits with a sign +"() {
        ...
        then:
        validator.isAnInteger(number) && validator.isAPositiveInteger(number) && number.size() == 13
    }
    ...
    def "create a random negative integer of 12 digits"() {
        ...
        then:
        validator.isAnInteger(number) && validator.isANegativeInteger(number) && number.size() == 13
    }
    ...
    def "create a list of random integers of different size"() {
        ...
        then:
        list.each({ number -> validator.isAnInteger(number) }).inject(true) { result, i -> result && i }
    }
    ...
    def "create a list of minimum 1 and maximum 30 random integers"() {
        ...
        list = generator.createList(15, randomizer.nextBoolean(), randomizer.nextBoolean(), 30, true)
        then:
        list.size() <= 30 && list.size() > 0 && list.each({ number -> validator.isAnInteger(number) }).inject(true) { result, i -> result && i }
    }
    ...
    def "create a list of 20 integers"() {
        ...
        then:
        list.size() == 20 && list.each({ number -> validator.isAnInteger(number) }).inject(true) { result, i -> result && i }
    }
    ...
    def "create an array of 20 integers"() {
        ...
        then:
        array.size() == 20 && array.each({ number -> validator.isAnInteger(number) }).inject(true) { result, i -> result && i }
    }
    ...
    def "create a list of 1 integer"() {
        ...
        then:
        list.size() == 1 && list.each({ number -> validator.isAnInteger(number) }).inject(true) { result, i -> result && i }
    }
    ...
    def "create an array of 1 integer"() {
        ...
        then:
        array.size() == 1 && array.each({ number -> validator.isAnInteger(number) }).inject(true) { result, i -> result && i }
    }
